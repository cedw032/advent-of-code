...
main :: Effect Unit
main = do
  log $ show $ toRawPassports rawInput



toRawPassportFields :: String -> Array String


toRawPassports :: String -> Array String
toRawPassports s = split (Pattern "\n\n") s

        


rawInput :: String
rawInput = """iyr:2010 ecl:gry hgt:181cm
